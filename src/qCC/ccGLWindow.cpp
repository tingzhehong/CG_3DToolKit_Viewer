...
void ccGLWindow::drawClickableItems(int xStart0, int& yStart)
{
	...
	//"exit" icon
    static const QImage c_exitIcon = QImage(":/CC/res/images/ccExit.png").mirrored();
	...
	if (m_clickableItemsVisible)
	{
        static const QImage c_minusPix = QImage(":/CC/res/images/ccMinus.png").mirrored();
        static const QImage c_plusPix = QImage(":/CC/res/images/ccPlus.png").mirrored();
